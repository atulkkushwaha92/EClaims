          ...
          <Grid container display="flex" spacing={4}>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                ...
                <Typography variant="body2" color={Palette.grey[600]} textTransform={"capitalize"}>{data?.address ? data?.address : "---"}</Typography>
              </Grid>
              <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">State</Typography>
               <Typography variant="body2" color={Palette.grey[600]} textTransform={"capitalize"}>{data?.state ? data?.state : "---"}</Typography>
              </Grid>
            </Grid>
			<Grid item xs={12} sm={6}>
              <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                <Typography variant="body1">City</Typography>
                <Typography variant="body2" color={Palette.grey[600]} textTransform={"capitalize"}>{data?.city ? data?.city : "---"}</Typography>
              </Grid>
              <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2}>
                <Typography variant="body1">Country</Typography>
               <Typography variant="body2" color={Palette.grey[600]} textTransform={"capitalize"}>{data?.country ? data?.country : "---"}</Typography>
              </Grid>
            </Grid>
          </Grid>
        </Box>
